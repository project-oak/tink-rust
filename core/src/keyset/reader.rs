...
/// [`EncryptedKeyset`](tink_proto::EncryptedKeyset) from some source.
///
/// In order to turn a `Reader` into a [`keyset::Handle`](crate::keyset::Handle) for use, callers
/// must use `insecure::new_handle` or [`Handle::read`](super::Handle::read) (with encryption).
pub trait Reader {
