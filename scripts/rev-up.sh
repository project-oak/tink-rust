...
CRATE_DIRS=(proto tink prf mac aead daead streaming signature integration/awskms rinkey tests testing examples/aead examples/daead examples/keygen examples/keymgr examples/kms examples/mac examples/signature examples/streaming)
